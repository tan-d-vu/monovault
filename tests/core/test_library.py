...
class TestLibraryManager:
    ...
    @pytest.mark.unit
    def test_add_track_returns_positive_int(
    ...
    @pytest.mark.unit
    def test_add_track_deduplicates_by_file_path(
        self, library: LibraryManager, sample_track: Track
    ) -> None:
    ...
    @pytest.mark.unit
    def test_get_all_tracks_with_multiple(
        self, library: LibraryManager, sample_tracks: list[Track]
    ) -> None:
    ...
    @pytest.mark.unit
    def test_update_track_changes_stored_track(
        self, library: LibraryManager, sample_track: Track
    ) -> None:
        track_id = library.add_track(sample_track)
        ...
        modified = make_track(
            track_id=track_id, file_path=sample_track.file_path, title="New Title"
        )
    ...
    @pytest.mark.unit
    def test_get_tracks_by_artist_case_insensitive(
        self, library: LibraryManager, sample_track: Track
    ) -> None:
        library.add_track(sample_track)
        results = library.get_tracks_by_artist("test artist")
    ...
    @pytest.mark.unit
    def test_get_tracks_by_artist_not_found(
        self, library: LibraryManager, sample_track: Track
    ) -> None:
        library.add_track(sample_track)
    ...
    @pytest.mark.unit
    def test_get_tracks_with_categories_found(
        self, library: LibraryManager, sample_track: Track
    ) -> None:
        library.add_track(sample_track)
    ...
    def test_get_tracks_with_categories_any_match(
        ...
        sample_track: Track,
        sample_track_no_categories: Track,
    ) -> None:
